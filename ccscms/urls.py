...
from .views import (
    ...
    committee_page, list_committees, create_committee, update_committee, delete_committee, restore_committee,
    list_members, create_member, update_member, delete_member, restore_member,
    list_all_committee_members, list_all_committees_for_dropdown,
    get_member,
    list_all_committee_roles_for_dropdown,
    create_committee_role,
    faculty_list, faculty_form, faculty_create, faculty_update, faculty_delete, faculty_restore,
    faculty_detail,
    complaints_list,
...
urlpatterns = [
    ...
    path('cscadmin/complaints/', admin_complaints_page, name='admin_complaints_page'),
    ...
    # Committee Management URLs
    path('cscadmin/committees/', committee_page, name='committee_page'),
    path('cscadmin/committee-members/list/', list_all_committee_members, name='list_all_committee_members'),
    path('cscadmin/committees/all-for-dropdown/', list_all_committees_for_dropdown, name='list_all_committees_for_dropdown'),
    path('cscadmin/committees/roles/all-for-dropdown/', list_all_committee_roles_for_dropdown, name='list_all_committee_roles_for_dropdown'),
    path('cscadmin/committees/list/', list_committees, name='list_committees'),
    path('cscadmin/committees/create/', create_committee, name='create_committee'),
    path('cscadmin/committees/roles/create/', create_committee_role, name='create_committee_role'),
    path('cscadmin/committees/<int:committee_id>/update/', update_committee, name='update_committee'),
    path('cscadmin/committees/<int:committee_id>/delete/', delete_committee, name='delete_committee'),
    path('cscadmin/committees/<int:committee_id>/restore/', restore_committee, name='restore_committee'),
    path('cscadmin/committees/<int:committee_id>/members/', list_members, name='list_members'),
    path('cscadmin/committees/members/create/', create_member, name='create_member'),
    path('cscadmin/committees/members/<int:member_id>/', get_member, name='get_member'),
    path('cscadmin/committees/members/<int:member_id>/update/', update_member, name='update_member'),
    path('cscadmin/committees/members/<int:member_id>/delete/', delete_member, name='delete_member'),
    path('cscadmin/committees/members/<int:member_id>/restore/', restore_member, name='restore_member'),

    path('cscadmin/faculty/', faculty_list, name='admin_faculty_list'),
    path('cscadmin/faculty/form/', faculty_form, name='admin_faculty_form'),
    path('cscadmin/faculty/<int:pk>/form/', faculty_form, name='admin_faculty_form_edit_alt'),
    path('cscadmin/faculty/create/', faculty_create, name='admin_faculty_create'),
    path('cscadmin/faculty/<int:pk>/update/', faculty_update, name='admin_faculty_update'),
    path('cscadmin/faculty/<int:pk>/delete/', faculty_delete, name='admin_faculty_delete'),
    path('cscadmin/faculty/<int:pk>/restore/', faculty_restore, name='admin_faculty_restore'),
    path('cscadmin/faculty/<int:pk>/', faculty_detail, name='faculty_detail'),
    
    path('cscadmin/complaints/list/', complaints_list, name='complaints_list'),
    path('cscadmin/complaints/types/add/', add_complaint_type, name='add_complaint_type'),
    path('cscadmin/complaints/types/list/', list_complaint_types, name='list_complaint_types'),
    path('cscadmin/complaints/types/<int:type_id>/edit/', edit_complaint_type, name='edit_complaint_type'),
    path('cscadmin/complaints/types/<int:type_id>/delete/', delete_complaint_type, name='delete_complaint_type'),
    path('cscadmin/feedback/', admin_feedback_page, name='admin_feedback_page'),
    path('cscadmin/feedback/list/', admin_feedback_list, name='admin_feedback_list'),
    path('cscadmin/feedback/types/list/', list_feedback_types, name='list_feedback_types'),
    path('cscadmin/feedback/types/<int:type_id>/edit/', edit_feedback_type, name='edit_feedback_type'),
    path('cscadmin/feedback/types/<int:type_id>/delete/', delete_feedback_type, name='delete_feedback_type'),
]